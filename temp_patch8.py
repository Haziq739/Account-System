...
for fname in files_to_fix:
    ...
    # 1. STRIP THE BUGGY CSS PADDING AND HOVER OVERRIDES!
    # These are the actual cause of the black borders and wrong colors!
    ...
    # 2. Add the ultimate combo box fix
...
print("Applied BOTH ultimate fixes")
