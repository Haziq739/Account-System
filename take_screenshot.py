...
def take_screenshot():
    ...
    # We want to wait a bit, then show popup, then wait a bit, then screenshot
    def grab_screen():
        # Grab the entire screen to make sure we capture the popup window too
        screen = app.primaryScreen()
        # Save to artifacts directory
        artifact_dir = r"C:\Users\Muhammad Haziq Naeem\.gemini\antigravity-ide\brain\8b6d8335-21f4-46ac-aa39-61ad7ed463e7"
        screenshot_path = os.path.join(artifact_dir, "popup_screenshot.png")
